...
np.savetxt('./tests/test_data/scaler_ymat_mc.csv', ymat_mc, fmt='%.18e', delimiter=',', newline='\n',
           header='', footer='', comments='#')

np.savetxt('./tests/test_data/scaler_ymat_uv.csv', ymat_uv, fmt='%.18e', delimiter=',', newline='\n',
           header='', footer='', comments='#')

np.savetxt('./tests/test_data/scaler_ymat_par.csv', ymat_par, fmt='%.18e', delimiter=',', newline='\n',
           header='', footer='', comments='#')
